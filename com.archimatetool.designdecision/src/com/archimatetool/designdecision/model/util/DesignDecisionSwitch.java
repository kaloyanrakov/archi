...
public class DesignDecisionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IDesignDecisionPackage.DESIGN_DECISION: {
				IDesignDecision designDecision = (IDesignDecision)theEObject;
				T result = caseDesignDecision(designDecision);
				if (result == null) result = caseMotivationElement(designDecision);
				if (result == null) result = caseArchimateElement(designDecision);
				if (result == null) result = caseArchimateConcept(designDecision);
				if (result == null) result = caseArchimateModelObject(designDecision);
				if (result == null) result = caseCloneable(designDecision);
				if (result == null) result = caseDocumentable(designDecision);
				if (result == null) result = caseProperties(designDecision);
				if (result == null) result = caseProfiles(designDecision);
				if (result == null) result = caseAdapter(designDecision);
				if (result == null) result = caseNameable(designDecision);
				if (result == null) result = caseIdentifier(designDecision);
				if (result == null) result = caseFeatures(designDecision);
	 ...
	 * @generated
	 */
	public T caseDesignDecision(IDesignDecision object) {
		return null;
	}
